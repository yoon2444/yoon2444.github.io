...
<body>
  <h2>9월 20일</h2>
    <h3>소스 코드</h3>
  <img src="https://yoon2444.github.io/java/fRjsp_source.jpg">      <!-- 소스코드 캡처 화면 -->
    <h3>실행 예시</h3>
  <img src="https://yoon2444.github.io/java/fRjsp_result.jpg">       <!-- 이클립스 결과 캡처 화면 -->
</body>
</html>
